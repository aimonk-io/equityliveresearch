    ...
    <section className="mx-auto max-w-[1240px] px-6 py-24 sm:px-8">
      ...
      <div className="mt-11 grid gap-6 md:grid-cols-3">
        {testimonials.map((t) => (
          <figure
            key={t.name}
            className="flex flex-col rounded-[4px] border border-line-soft bg-cream-card p-[34px]"
          >
            ...
            <figcaption className="flex items-center gap-[13px]">
              <span className="flex size-[42px] items-center justify-center rounded-full bg-navy font-serif text-[18px] text-gold">
                {t.initial}
              </span>
              <span>
